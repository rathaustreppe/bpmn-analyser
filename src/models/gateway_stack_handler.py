...
class GatewayStackHandler:
    ...
    def check_gateway_stack(self, gateway: BPMNGateway,
       ...
       """
        if gateway.is_opening_gateway():
            # opening gateway: we need to push them and their branches on the stack
    ...
    def pop_gateway(self, branch_element: BPMNElement) -> None:
        ...
        GraphPointer & BPMNModel) knows what comes next after removing a closing gateway.
    ...
    def next_stack_element(self) -> Optional[Union[BPMNGateway, BPMNActivity, BPMNStartEvent, BPMNEndEvent, BPMNElement]]:

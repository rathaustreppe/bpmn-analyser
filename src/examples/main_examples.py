...
# Execute this file with python interpreter to see the power of BPMN-Analyzer :D
# When using NLTK the first time, you may need to download some NLP stuff.
# Download them via executing the commands:
# >>> import nltk;
# >>> nltk.download('wordnet');
# >>> nltk.download('punkt');
# >>> nltk.download('averaged_perceptron_tagger')
#
# ... and then run this file. It will execute two examples.
